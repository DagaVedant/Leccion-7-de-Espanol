    ...
    <div className="space-y-8 bg-[#FFF6CC]/30 p-4 md:p-6 rounded-2xl border border-yellow-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100">
          <h3 className="text-base font-bold text-slate-800 mb-3">📌 Uso y Significado</h3>
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100">
          <h3 className="text-base font-bold text-slate-800 mb-3">⚙️ Reglas de Conjugación</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100 flex-1">
          <h3 className="text-base font-bold text-slate-800 mb-4 pb-2 border-b">💥 Verbos Irregulares ('Yo' form)</h3>
